                ...
                <div class="col-md-12 mt-2">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-5">
                            <?
                            if ($this->session->flashdata('err_status') !== null) {
                                if ($this->session->flashdata('err_status')) {
                                    echo "<script>alertify.success('" . $this->session->flashdata('err_message') . "')</script>";
                                } else {
                                    echo "<script>alertify.error('" . $this->session->flashdata('err_message') . "')</script>";
                                }
                            }
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="projectCode"
                                            value="<?= $results->projectCode; ?>" aria-describedby="projectHelp"
                                            readonly required>
                                    </div>
                                    <div class="col-md-4">
