                ...
                <div class="col-md-12 mt-5">
                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="d-flex justify-content-start">
                                        <h5>ขอขยายระยะเวลารับรองโครงการ</h5>
                                    </div>
                                </div>
                                <div class="col">
                        ...
                        <div class="card-body p-5">
                            ...
                            ?>
                            <form action="<?= site_url('project/createExtend');?>" method="post">
                                <div class="form-row">
                                    <div class="col-md-4">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="certExtendedDate">วันที่ยื่นขอขยายระยะเวลารับรอง</label>
                                        <input type="date" class="form-control form-control-sm" name="certExtendedDate"
                                            required>
                                    </div>
                                </div>
                                <div class="form-row">
